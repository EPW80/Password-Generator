...
function generatePassword() {
  ...
  while (passLength < 8 || passLength > 128) {
        ...
        if (passLength < 8 || passLength > 128) {
          ...
          while (passwordCriteria.passwordLength < passLength) {
            ...
            if (
              ...
              passUpperCase === false &&
              passNumbers === false &&
              passSpecialCharacters === false
            ) {
              alert(
                "Please select either lowercase, uppercase, numbers or characters!"
              );
              displayPrompt();
            } else {
              ...
              if (
                passLowerCase === true &&
                passwordCriteria.passwordLength < passLength
              ) {
                var lowerCase =
                  passwordCriteria.passwordLowerCase[
              ...
              if (
                ...
                var upperCase =
                  passwordCriteria.passwordUpperCase[
                    Math.floor(Math.random() * 26)
                  ];
              ...
              if (
                ...
                var num =
                  passwordCriteria.passwordNumber[
              ...
              if (
                ...
                var passChar =
                  passwordCriteria.passwordCharacter[
    ...
    function displayPrompt() {
      ...
      passSpecialCharacters = confirm(
        "Are you sure you want to use any special characters?"
      );
    }
  }
}
